...
export function createEnhancedDesktopRelay(options: GrokCodexRelayOptions & { onStateChange?(event: { bridgeCallId: string; vendorCallId: string; state: string; [key: string]: unknown }): void }): ReturnType<typeof createGrokCodexRelay>;
